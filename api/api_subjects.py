...
client_secret = "fukT18aYcXn9nPbru69_4A"
...
if token_response.status_code == 200:
    ...
    api_url_base = "https://api.thuisarts.nl/v/1/subjects?_format=json&page="
    headers = {
    ...
    for i in range(1, 8): 
        ...
        if api_response.status_code == 200:
            ...
            all_subjects.extend(page_data.get('subjects', []))
    ...
    with open('data/all_subjects.json', 'w') as f:
