...
#get the task ids of the tasks in the database
cursor.execute('''
...
for task_id in task_ids:
    ...
    cursor.execute('''
    SELECT situationId, COUNT(*) AS occurrences
    FROM dblinks
    ...
    with open('data/testing.csv', 'w', newline='') as csvfile:
        ...
        csv_writer.writerow(['situation_id', 'occurrences'])  # Write header
